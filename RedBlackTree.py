...
# Benchmarking wrapper for memory
def memory_function(func):
    def wrapper(*args, **kwargs):
        ...
        tracemalloc.stop()
        print(f"Function {func.__name__} used {current / 1024:.2f} KB (current), {peak / 1024:.2f} KB (peak) memory")
        return result
    return wrapper
